# Autoencoders
The autoencoder is trained to reconstruct the input data by adjusting its weights during the training phase. As shown in![Figure 1: Structure of the Autoencoder](main/images/Autoencoder.jpg), the autoencoder consists of three main elements:
